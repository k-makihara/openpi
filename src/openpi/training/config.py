...
class DataConfig:
    ...
    # Sample every N-th frame when building the action sequence.
    # For example, for a 60Hz dataset use 3 to train with an effective 20Hz action chunk.
    action_sample_stride: int = 1
    # Optional explicit delta_timestamps (in seconds) for specific dataset keys.
    # If set, these are passed directly to LeRobotDataset and take precedence over action_sequence_keys.
    delta_timestamps_overrides: dict[str, Sequence[float]] | None = None
    # Timestamp tolerance in seconds for LeRobot video/frame alignment.
    lerobot_tolerance_s: float = 1e-4
    # Video decoder backend for LeRobot datasets. "pyav" is often more robust
    # than torchcodec for boundary-frame access on some datasets.
...
@dataclasses.dataclass(frozen=True)
class LeRobotUmiOriginalBimanualDataConfig(DataConfigFactory):
    """Bimanual UMI config based on controller poses + absolute grippers."""
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_umi_original_right_h16_bs32_10step",
    ...
    TrainConfig(
        name="pi05_umi_original_right_third_slot_relative_h16_bs32_30k_10hz",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=16, action_dim=32, discrete_state_input=False),
        data=LeRobotUmiOriginalRightThirdSlotDataConfig(
            repo_id="/groups/gag51454/workspace_makihara/dataset/lerobot_v21_ph2_success_right_v2",
            base_config=DataConfig(prompt_from_task=True, lerobot_tolerance_s=0.02),
    ...
    TrainConfig(
        name="pi05_umi_original_right_prev_current_third_slot_relative_h16_bs32_30k_10hz",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=16, action_dim=32, discrete_state_input=False),
        data=LeRobotUmiOriginalRightPrevCurrentThirdSlotDataConfig(
            repo_id="/groups/gag51454/workspace_makihara/dataset/lerobot_v21_ph2_success_right_v2",
            base_config=DataConfig(prompt_from_task=True, lerobot_tolerance_s=0.02),
    ...
    TrainConfig(
        name="pi05_umi_original_dual_arm_relative_state_hz30_h32_bs32_30k_peginhole",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=32, action_dim=32, discrete_state_input=False),
        data=LeRobotUmiOriginalDualArmRelativeStateDataConfig(
            repo_id="/groups/gag51454/workspace_makihara/dataset/lerobot_v21_ph2_success_peginhole_clearance",
            base_config=DataConfig(prompt_from_task=True, lerobot_tolerance_s=0.05),
            downsample_step=2,
            history_steps=4,
            action_horizon_steps=32,
            action_pose_target="relative",
        ),
        batch_size=32,
        lr_schedule=_optimizer.CosineDecaySchedule(
    ...
    TrainConfig(
        name="pi05_umi_original_dual_arm_relative_state_hz30_h32_bs32_30k_assemblyecu_200",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=32, action_dim=32, discrete_state_input=False),
        data=LeRobotUmiOriginalDualArmRelativeStateDataConfig(
            repo_id="/groups/gag51454/workspace_makihara/dataset/assem/lerobot_v21_ph2_success_200",
            base_config=DataConfig(prompt_from_task=True, lerobot_tolerance_s=0.05),
            downsample_step=2,
            history_steps=4,
            action_horizon_steps=32,
    ...
    TrainConfig(
        name="pi05_umi_original_dual_arm_relative_state_hz10_h16_bs32_30k_assemblyecu_200",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=16, action_dim=32, discrete_state_input=False),
        data=LeRobotUmiOriginalDualArmRelativeStateDataConfig(
            repo_id="/groups/gag51454/workspace_makihara/dataset/assem/lerobot_v21_ph2_success_200",
            base_config=DataConfig(prompt_from_task=True, lerobot_tolerance_s=0.05),
    ...
    TrainConfig(
        name="pi05_umi_original_dual_arm_relative_state_hz60_h64_bs32_30k_assemblyecu_200",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=64, action_dim=32, discrete_state_input=False),
        data=LeRobotUmiOriginalDualArmRelativeStateDataConfig(
            repo_id="/groups/gag51454/workspace_makihara/dataset/assem/lerobot_v21_ph2_success_200",
            base_config=DataConfig(prompt_from_task=True, lerobot_tolerance_s=0.05),
            downsample_step=1,
            history_steps=4,
            action_horizon_steps=64,
            action_pose_target="relative",
        ),
        batch_size=32,
        lr_schedule=_optimizer.CosineDecaySchedule(
    ...
    TrainConfig(
        name="pi05_umi_original_bimanual_h16_bs32_10step",
        project_name="pi05_genoma",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=16, action_dim=32, discrete_state_input=False),
        data=LeRobotUmiOriginalBimanualDataConfig(
            repo_id="/groups/gag51454/workspace_makihara/dataset/lerobot_v21_ph2_success",
